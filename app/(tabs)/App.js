...
//Esta parte la vamos a quitar por navigate a tu página
...
// useEffect para detectar cambios en la autentificación del usuario.
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, (user) => {
      setUser(user); //Actualiza el estado con el usuario autentificado o null si ha sido cerrado.
    });

    return () => unsubscribe();  // Limpia el observador cuando el componente se desmonta(nose muy bien)
  }, [auth]);
